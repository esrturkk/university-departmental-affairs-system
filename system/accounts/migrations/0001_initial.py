    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='no-reply@example.com', max_length=254, verbose_name='E-posta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.role', verbose_name='Rol')),
            ],
            options={
