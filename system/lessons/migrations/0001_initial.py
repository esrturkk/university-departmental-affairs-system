# Generated by Django 5.0.6 on 2025-06-08 00:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_instructor', models.ForeignKey(blank=True, limit_choices_to={'role__title__in': ['Öğretim Elemanı', 'Bölüm Başkanı']}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Öğretim Elemanı veya Bölüm Başkanı')),
            ],
            options={
                'verbose_name': 'ders',
